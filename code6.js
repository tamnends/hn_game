...
gdjs.EndScreenCode.userFunc0x4ad8a30 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0x4ad8a30(runtimeScene);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(105947716);
}
}
}
if (isConditionTrue_0) {
...
gdjs.EndScreenCode.asyncCallback105951652 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback105951652(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(105951084);
}
}
}
if (isConditionTrue_0) {
...
gdjs.EndScreenCode.asyncCallback105952812 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.EndScreenCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.EndScreenCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback105952812(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(105952396);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "bassa-island-game-loop-kevin-macleod-main-version-8008-00-32.mp3", 0, true, 90, 1);
}}
