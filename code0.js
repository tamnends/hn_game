...
gdjs.MainMenuCode.userFunc0x3b13790 = function GDJSInlineCode(runtimeScene) {
"use strict";
(function () {
...
gdjs.MainMenuCode.asyncCallback90840812 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.MainMenuCode.asyncCallback90840812(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.MainMenuCode.asyncCallback90838692 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.MainMenuCode.localVariables);
...
};gdjs.MainMenuCode.asyncCallback90838356 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.MainMenuCode.localVariables);
...
};gdjs.MainMenuCode.asyncCallback90838124 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.MainMenuCode.localVariables);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.MainMenuCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.MainMenuCode.asyncCallback90838124(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.MainMenuCode.userFunc0x3b13790(runtimeScene);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(90843148);
}
}
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(90845388);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(90847564);
}
}
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(90849972);
}
}
}
}
...
}{gdjs.evtTools.sound.playSoundOnChannel(runtimeScene, "assets\\Music&SoundEffects\\bassa-island-game-loop-kevin-macleod-main-version-8008-00-32.mp3", 0, true, 60, 1);
}
{ //Subevents
